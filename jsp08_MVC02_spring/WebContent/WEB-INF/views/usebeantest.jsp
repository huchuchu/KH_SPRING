...
<body>
	...
	<jsp:useBean id="dtos" class="com.mvc.my.model.dto.MyMvcDto" scope="page"></jsp:useBean>
	...
	<jsp:useBean id="abc" class="com.mvc.my.model.dto.MyMvcDto" scope="session"></jsp:useBean>
